...
## [0.15.0](https://github.com/konippi/servo-fetch/compare/0.14.2..0.15.0) - 2026-09-22
...
- *(cli)* Report batch and crawl failures in exit status ([#500](https://github.com/konippi/servo-fetch/pull/500))
- *(cli)* Own and drain the stderr filter before exiting (#498)
...
- *(tests)* Eliminate worker PID publication race ([#437](https://github.com/konippi/servo-fetch/pull/437))
...
## [0.14.1](https://github.com/konippi/servo-fetch/compare/0.14.0..0.14.1) - 2026-08-28
...
- *(tests)* Poll for parseable pid in graceful-close session test (#410)
...
- *(deps)* Bump rmcp from 2.2.0 to 3.1.0 (#403)
